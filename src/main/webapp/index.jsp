...
<body>
        <header id="header" class="header" >
            <div class="container">
                ...
                <div id="logo" class="pull-left">
                    <h1><a href="#intro" class="scrollto">WoodStore</a></h1>
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="${contextPath}/enter">My acc</a></li>
                        </c:if>
                        <c:if test="${not empty sessionScope.admin}">
                            <li><a href="${contextPath}/enterAdmin">Admin Panel</a></li>
                        </c:if>
        ...
        <section id="offer" class="offer d-flex justify-content-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <img src="img/topori.jpg" alt="topori" class="topori" /></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="feature" class="feature">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4">
                    <div class="feature__item d-flex">
                        <i class="fa fa-twitter-square feature__item__icon"></i>
                        <div class="feature__item__block">
                            <h3 class="feature__item__title">
                                Lorem ipsum dolor sit
                            </h3>
                            <p class="feature__text">
                                Lorem ipsum dolor sit ametLorem ipsum dolor sit ametLorem ipsum dolor si
                            </p>
                        </div>
                    </div>
                </div>
